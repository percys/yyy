...
public class ExternalYgDaoImpl extends HibernateDaoSupport implements ExternalYgDao {

	public Long getCommodityTotal(QueryInternalNbjs toto) {
		// TODO Auto-generated method stub
		String hql = "select count(*) from TtotdzrptShwbjs where 1=1 and orgcode='"+toto.getOrgcode()+"'";
	...
	public List<TtotdzrptShwbjs> doSplitPage(final int page, final int rows,
			final QueryInternalNbjs toto) {
		// TODO Auto-generated method stub
		List list = getHibernateTemplate().executeFind(new HibernateCallback() {
			public Object doInHibernate(Session session)
					throws HibernateException, SQLException {
				String hql = "from TtotdzrptShwbjs where 1=1 and orgcode='"+toto.getOrgcode()+"'";
				List<String> values = new ArrayList<String>();
				if (toto != null) {
					hql = jointHQL(hql, toto, values);
				}
