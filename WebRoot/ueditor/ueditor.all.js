    ...
    UE.commands['inserttable'] = {
        ...
        execCommand: function (cmd, opt) {
            function createTable(opt, tdWidth) {
                ...
                //禁止指定table-width
                return '<table  border="0" cellspacing="0" cellpadding="0"><tbody>' + html.join('') + '</tbody></table>'
            }
    ...
    Popup.prototype = {
        ...
        showAnchorRect: function ( rect, hoz, adj ){
            ...
            if(this.editor){
                ...
                baidu.editor.ui.uiUtils.getFixedLayer().style.zIndex = popEl.style.zIndex + 10;//表情
            }
...
//            }
        ...
        _show: function (){
            if (this._hidden) {
                ...
                this._hidden = false;
                this.fireEvent('show');
                baidu.editor.ui.uiUtils.getFixedLayer().style.zIndex = this.getDom().style.zIndex + 10;
            }
        },
        isHidden: function (){
            return this._hidden;
