...
function csv(){
	...
	var grid = $('#webNBjmDatagrid');  
	var options = grid.datagrid('getPager').data("pagination").options;  
    var url = 'ttotdzrptnb_csv.action?page='+options.pageNumber+'&rows='+options.total+'&begindate='+begindate+'&enddate='+enddate;  
...
<div id="Nbjmtoolbar">
	<form id="NBjmWebForm">
		...
		<a href="javascript:" class="easyui-linkbutton" plain="false" iconCls="icon-search" onclick="searchForm('#webNBjmDatagrid','#NBjmWebForm')">查询</a>
		<a href="javascript:" class="easyui-linkbutton" plain="false" iconCls="icon-search" onclick="formClean('#NBjmWebForm')">清空</a>
		<a href="javascript:" class="easyui-linkbutton" plain="true" iconCls="icon-print" onclick="csv()">导出</a>
	</form>
</div>
<table id="webNBjmDatagrid" class="easyui-datagrid" style="height: 400px; width: 100px;"
data-options="title:'账单详细列表',url:'ttotdzrptnb_getAll.action',border:false,fit:true,fitColumns:false,columns:[[
...
]],toolbar: '#Nbjmtoolbar',pagination:true,nowrap:false,onSelect:onSelectRow,onUnselect:onSelectRow               
">                                                                                                                      
</table>