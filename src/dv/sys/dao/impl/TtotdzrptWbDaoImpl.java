...
public class TtotdzrptWbDaoImpl extends HibernateDaoSupport implements
		TtotdzrptWbDao {

	public Long getCommodityTotal(QueryInternalNbjs toto) {
		// TODO Auto-generated method stub
		String hql = "select count(*) from TtotdzrptWb where 1=1";
	...
	public List<TtotdzrptWb> doSplitPage(final int page, final int rows,
		...
		List list = getHibernateTemplate().executeFind(new HibernateCallback() {
			public Object doInHibernate(Session session)
				...
				String hql = "from TtotdzrptWb where 1=1";
				List<String> values = new ArrayList<String>();
				if (toto != null) {
					hql = jointHQL(hql, toto, values);
				}
