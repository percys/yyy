...
function csv(){
	...
	var grid = $('#webYgNBjmDatagrid');  
	var options = grid.datagrid('getPager').data("pagination").options;  
    var url = 'ttotdzrptnbYg_csv.action?page='+options.pageNumber+'&rows='+options.total+'&begindate='+begindate+'&enddate='+enddate;  
...
<div id="YgNbjmtoolbar">
	<form id="YgNBjmWebForm">
		...
		<a href="javascript:" class="easyui-linkbutton" plain="false" iconCls="icon-search" onclick="searchForm('#webYgNBjmDatagrid','#YgNBjmWebForm')">查询</a>
		<a href="javascript:" class="easyui-linkbutton" plain="false" iconCls="icon-search" onclick="formClean('#YgNBjmWebForm')">清空</a>
		<a href="javascript:" class="easyui-linkbutton" plain="true" iconCls="icon-print" onclick="csv()">导出</a>
	</form>
</div>
<table id="webYgNBjmDatagrid" class="easyui-datagrid" style="height: 400px; width: 100px;"
data-options="title:'账单详细列表',url:'ttotdzrptnbYg_getAll.action',border:false,fit:true,fitColumns:false,columns:[[
...
]],toolbar: '#YgNbjmtoolbar',pagination:true,nowrap:false,onSelect:onSelectRow,onUnselect:onSelectRow               
">                                                                                                                      
</table>